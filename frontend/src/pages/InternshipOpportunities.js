    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-5">
            ...
            <div
                ...
                style={{
                    backgroundImage: "url('/student8.png')"
                }}
            ></div>
            ...
            <div className="relative bg-white rounded-xl w-full max-w-5xl max-h-[90vh] flex flex-col shadow-2xl z-10">
                <div className="relative p-6 bg-gradient-to-r from-indigo-600 to-indigo-500 rounded-t-xl">
                    <h1 className="mb-2 text-3xl font-bold text-white">Internship Opportunities</h1>
                    <p className="text-sm text-white text-opacity-90">Find internships to gain valuable experience </p>
                    <button
                        ...
                        <div className="grid grid-cols-3 gap-4">
                            {opportunities.length > 0 ? (
                                ...
                                <div className="col-span-3 py-16 text-center">
                                    ...
                                    <h3 className="mb-2 text-xl font-semibold text-gray-700">No internship opportunities found</h3>
